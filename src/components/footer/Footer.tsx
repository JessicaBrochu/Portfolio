      ...
      <footer>
        <div className="wrapper">
            <nav className="footer-nav">
                <ul>
                  <li className='li-footer'><Link to="/" state={{scrollId: '#hero'}}>ACCUEIL</Link></li>
                    <li className='li-footer'><Link to="/" state={{scrollId: '#projects'}}>PROJETS</Link></li>
                    <li className='li-logo'><Link to="/" state={{scrollId: '#hero'}} className="logo">
                      <svg width="30" height="30" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="logo">
                    ...
                    <li className='li-footer'><Link to="/" state={{scrollId: '#about'}}>À PROPOS</Link></li>
                    <li className='li-footer'><Link to="/" state={{scrollId: '#contact'}}>CONTACT</Link></li>
                </ul>
            </nav>
