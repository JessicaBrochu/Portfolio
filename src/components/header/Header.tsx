...
const Header = () => {
    ...
    const handleClick = () => {
        document.getElementById('hamburger')?.classList.toggle('hamburger-is-active')
    ...
    return (
        <div className="header">
            ...
            <nav className="desktop-nav" id="nav">
                <ul>
                    <li onClick={handleClick}><Link to="/" state={{ scrollId: '#hero' }}>ACCUEIL</Link></li>
                    <li onClick={handleClick}><Link to="/" state={{ scrollId: '#projects' }}>PROJETS</Link></li>
                    <li onClick={handleClick}><Link to="/" state={{ scrollId: '#about' }}>À PROPOS</Link></li>
                    <li onClick={handleClick}><Link to="/" state={{ scrollId: '#contact' }}>CONTACT</Link></li>
                </ul>
            </nav>
            <button onClick={handleClick} className="header-toggle" id="hamburger" aria-label="hamburger-menu">
                <span></span>
                <span></span>
                <span></span>
            </button>
